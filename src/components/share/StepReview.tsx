  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1">
        <h2 className="text-xl font-bold mb-1" style={{ color: '#12151C' }}>Review & Share</h2>
        <p className="text-sm mb-5" style={{ color: '#8A93A3' }}>Confirm the details before sharing.</p>
        ...
        <div className="rounded-2xl overflow-hidden" style={{ background: '#FFFFFF', border: '1px solid #EEF1F6' }}>
          ...
          <div className="px-4 py-4 border-b" style={{ borderColor: '#EEF1F6' }}>
            <p style={{ fontSize: 10, color: '#8A93A3', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700, marginBottom: 8 }}>Sharing with</p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: '#EAF1FF' }}>
              ...
              <div>
                <p className="text-sm font-bold" style={{ color: '#12151C' }}>{provider.name}</p>
                <p className="text-xs" style={{ color: '#8A93A3' }}>{provider.organization}</p>
              </div>
            </div>
          </div>
              ...
              {records.map((r) => {
                ...
                return (
                  <div key={r.id} className="flex items-center gap-2">
                    ...
                    <span className="text-xs" style={{ color: '#8A93A3' }}>{formatRecordDate(r.record_date)}</span>
                  </div>
                );
              })}
            </div>
          ...
          <div className="px-4 py-4">
            <p style={{ fontSize: 10, color: '#8A93A3', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700, marginBottom: 4 }}>Access duration</p>
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold" style={{ color: '#12151C' }}>{ACCESS_DURATION_LABELS[duration]}</p>
            </div>
          </div>
        </div>
