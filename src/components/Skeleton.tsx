    ...
    <div className="px-4 pt-6 pb-4">
      ...
      <div className="flex gap-2 mb-4">
        {[60, 44, 88, 72, 96, 80].map((w, i) => (
          <Skeleton key={i} className={`h-8 w-${w} rounded-full flex-shrink-0`} style={{ width: w }} />
        ))}
      </div>
      ...
      <div className="space-y-3">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="bg-white rounded-2xl px-4 py-4 border border-slate-100 flex items-center gap-4">
