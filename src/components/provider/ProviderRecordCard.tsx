...
export function ProviderRecordCard({ record, onClick, loading }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {loading ? (
          <svg className="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24" stroke="var(--muted)">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs mt-0.5 truncate" style={{ color: 'var(--muted)' }}>{record.provider_name}</p>
